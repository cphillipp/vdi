    ...
    public static function change_options() {
        ...
        switch ($action_type) {
            case 'save':
                if (!empty($data)) {
                    ...
                    foreach ($data as $option => $newvalue) {
                        ...
                        if ($option == "sliders") {
                            ...
                            update_option(THEMEMAKERS_THEME_PREFIX . $option, '');
                            update_option(THEMEMAKERS_THEME_PREFIX . $option, $newvalue);
                            continue;
                        }
                ...
                _e('Options have been updated.', THEMEMAKERS_THEME_FOLDER_NAME);
                break;
            ...
            case 'reset':
                ...
                _e('Options have been reset.', THEMEMAKERS_THEME_FOLDER_NAME);
                break;
